...
public class FullPostRepository {
    ...
    public List<FullPostDTO> getPostContent() {
        try {
            return entityManager.createNativeQuery("SELECT r.topic, content, r.creation_date, r.post_title_id, r.user_id, r.count AS likes_count " +
                            ...
                            "ON pc.post_title_id_fk = r.post_title_id", "PostContentDTOMapping")
                    .getResultList();
